        ...
        <div className="mx-auto w-full max-w-[2200px] space-y-10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            ...
            <div className="flex flex-wrap gap-3 sm:gap-6 justify-center md:justify-start text-center md:text-left relative md:-ml-4">
              ...
              <a href="/about" className="text-md hover:underline font-avenir-next-lt-pro-light font-light">About</a>
              <a href="/contact" className="text-md hover:underline font-avenir-next-lt-pro-light font-light">Contact</a>
            </div>

            {/* Description section */}
            <div className="text-[1.05rem] text-center md:text-left" style={{ fontFamily: 'Crimson Text, serif' }}>
              Established in 2019, Nicara is a full-service design and lifestyle studio based in Hyderabad, India.
            </div>

            {/* Social section */}
            <div className="text-[1.05rem] text-center md:text-left space-y-1" style={{ fontFamily: 'Crimson Text, serif' }}>
              <div>
          ...
          {/* Bottom section */}
          <div className="flex flex-col md:flex-row justify-between items-center text-[1.05rem] gap-4 text-center md:text-left" style={{ fontFamily: 'Crimson Text, serif' }}>
            <div>
            ...
            <div style={{ fontFamily: 'Crimson Text, serif' }}>Nicara Design © 2025</div>
          </div>
        </div>
      </footer>
    </div>
